    ...
    public partial class clinic_search : Form
    {
            ...
            if (textBox1.Text == cmd.Connection.Database || textBox1.MaxLength == 13)
            {
                ...
                foreach (DataRow item in dt.Rows)
                {
                    ...
                    if (privil_status == "ได้รับสิทธิการรักษา")
                    {
                        ...
                        {
                            dataGridView1.Rows[n].Cells[5].Value = "แพทย์ขอเลื่อนนัดหมายการรักษา";
                        }
                        else if (status_approve == "4")
                        {
                            dataGridView1.Rows[n].Cells[5].Value = "รออนุมัติการนัดหมาย";
                        }
                        else if (status_approve == "5")
                        {
                            dataGridView1.Rows[n].Cells[5].Value = "อนุมัติเรียบร้อยแล้ว";
                        }
        ...
        private void bt2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("ไม่สามารถส่งคิวการให้บริการได้");
                }
      ...
      */
       ...
       /*     time += ".";
        ...
        private void clinic_search_Load(object sender, EventArgs e)
        {
            ...
            label4.Text = DateTime.Now.ToString("yyyy-MM-dd", new CultureInfo("th-TH"));
