...
{
    public partial class clinic_room1_now : Form
    {
        ...
        public clinic_room1_now()
        {
            ...
            string query = ("select schedule_work_doctor.swd_month_work,employee_doctor.emp_doc_name,schedule_work_doctor.swd_day_work,schedule_work_doctor.swd_date_work,schedule_work_doctor.swd_start_time,schedule_work_doctor.swd_end_time,schedule_work_doctor.swd_note,schedule_work_doctor.room_id,schedule_work_doctor.swd_status_room,schedule_work_doctor.swd_timezone,schedule_work_doctor.swd_status from schedule_work_doctor inner join room on room.room_id = schedule_work_doctor.room_id inner join employee_doctor on schedule_work_doctor.emp_doc_id = employee_doctor.emp_doc_id where schedule_work_doctor.room_id = 1 AND swd_month_work = '"+month+"'");
        ...
        private void clinic_room1_now_Load(object sender, EventArgs e)
        {
            string month = DateTime.Now.ToString("MMMM", new CultureInfo("th-TH"));
            label3.Text = month;
